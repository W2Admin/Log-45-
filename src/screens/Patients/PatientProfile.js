...
function PatientProfile({loading, singlefetchpatient, singlepatient}) {
      ...
      {loading ? (
        ...
        <>
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-semibold">{singlepatient?.first_name} {singlepatient?.last_name}</h1>
          </div>
          <div className=" grid grid-cols-12 gap-6 my-8 items-start">
            ...
            >
              ...
              <div className="gap-2 flex-colo">
                <h2 className="text-sm font-semibold">{singlepatient?.first_name} {singlepatient?.last_name}</h2>
                <p className="text-xs text-textGray">{singlepatient?.email}</p>
                <p className="text-xs">{singlepatient?.phone}</p>
              </div>
              {/* tabs */}
...
export default connect(mapStoreToProps, mapDispatchToProps)(PatientProfile);
