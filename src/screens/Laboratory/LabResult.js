...
//                         <p className="text-sm text-gray-700">Anami Ammasty</p>
//                       </div>
//                       <div>
//                         <p className="text-sm font-medium">Animal Type</p>
//                         <p className="text-sm text-gray-700">Dog</p>
//                       </div>
//                       <div>
//                         <p className="text-sm font-medium">Species</p>
//                         <p className="text-sm text-gray-700">Rotwellier</p>
//                       </div>
//                       <div>
//                         <p className="text-sm font-medium">
//                           Examination Request
//                         </p>
//                         <p className="text-sm text-gray-700">Headache</p>
//                       </div>
//                     </>
//                   )}
//                 </div>
...
//                 <p className="text-sm font-medium text-green-600">#22,200</p>
//               </div>
//             </div>
//           </div>
//         </div>
